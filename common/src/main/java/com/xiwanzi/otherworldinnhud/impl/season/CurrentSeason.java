...
public class CurrentSeason {
    ...
    switch (showDay) {
      ...
      case SHOW_WITH_MONTH:
        if (CommonSeasonHelper.commonSeasons.getHelper().isSeasonTiedWithSystemTime()) {
          ...
          Component currentMonth = Common.translatedText("desc.otherworldinn_hud.month" + "." + systemMonthString);
  ...
  public MutableComponent getHudTextNoFormat() {
    MutableComponent seasonIcon = Common.translatedText("desc.otherworldinn_hud.hud.icon", currentSeason.getIconChar());
    MutableComponent seasonText = getText(OtherworldInnHudClient.getShowDay(), OtherworldInnHudClient.getShowSubSeason()).copy();

    return Common.translatedText("desc.otherworldinn_hud.hud.combined", seasonIcon.withStyle(seasonIconFormat), seasonText);
  }
  ...
  public MutableComponent getHudText() {
    ...
    return Common.translatedText("desc.otherworldinn_hud.hud.combined", seasonIcon.withStyle(seasonIconFormat),
