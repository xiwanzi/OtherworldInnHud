package com.xiwanzi.otherworldinnhud.impl.season.mods.sereneseasons;
...
public class SereneSeasonsHelper implements SeasonModHelper {
  ...
  public boolean isTropicalSeason(Player player) {
    boolean showTropicalSeasons = OtherworldInnHudClient.getShowTropicalSeason();
  ...
  public long getDate(Player player) {
    ...
    if (subSeasonDuration != OtherworldInnHudServer.getSubSeasonLength()) {
      subSeasonDuration = OtherworldInnHudServer.getSubSeasonLength();
    }
