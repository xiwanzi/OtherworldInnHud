package com.xiwanzi.otherworldinnhud.impl.accessory.mods;
...
public class Calendar {
  ...
  public static boolean validNeedCalendar(Player player) {
    return (OtherworldInnHudServer.getNeedCalendar() && Calendar.calendarFound(player)) || !OtherworldInnHudServer.getNeedCalendar();
  }

  public static boolean validDetailedMode(Player player) {
    return (OtherworldInnHudServer.getCalendarDetailMode() && Calendar.calendarFound(player))
        || !OtherworldInnHudServer.getCalendarDetailMode();
  }
}