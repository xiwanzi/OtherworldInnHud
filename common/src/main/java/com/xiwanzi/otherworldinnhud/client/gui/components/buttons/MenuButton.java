package com.xiwanzi.otherworldinnhud.client.gui.components.buttons;

import com.xiwanzi.otherworldinnhud.Common;
import com.xiwanzi.otherworldinnhud.client.gui.screens.OtherworldInnHudScreen;
...
public class MenuButton extends Button {
  ...
  public static Builder builder(MenuButtons button, OtherworldInnHudScreen currentScreen, OtherworldInnHudScreen newScreen) {
  ...
  public enum MenuButtons {
    ...
    COLORS(Common.translatedText("menu.otherworldinn_hud.main.color.button").append("...")),

    SEASON(Common.translatedText("menu.otherworldinn_hud.main.season.button").append("...")),

    JOURNEYMAP(Common.translatedText("menu.otherworldinn_hud.main.journeymap.options.button").append("..."));
