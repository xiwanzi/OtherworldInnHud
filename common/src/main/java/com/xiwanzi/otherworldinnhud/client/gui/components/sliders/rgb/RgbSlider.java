package com.xiwanzi.otherworldinnhud.client.gui.components.sliders.rgb;
...
public class RgbSlider extends BasicSlider {
  ...
  private final boolean enableColor = OtherworldInnHudClient.getEnableSeasonNameColor();
