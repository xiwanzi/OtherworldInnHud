package com.xiwanzi.otherworldinnhud;

import com.xiwanzi.otherworldinnhud.config.OtherworldInnHudClient;
import com.xiwanzi.otherworldinnhud.impl.accessory.mods.AccessoryMods;
...
public class Common {
  public static final String MOD_ID = "otherworldinn_hud";
  public static final String MOD_NAME = "Otherworld Inn HUD";
  ...
  public static boolean minimapIntegrationHidden(Minecraft mc) {
    return OtherworldInnHudClient.getEnableMinimapIntegration() && (CurrentMinimap.allMinimapsHidden(mc)
        && OtherworldInnHudClient.getShowDefaultWhenMinimapHidden());
  }
  ...
  public static boolean drawDefaultHud(Minecraft mc) {
    ...
    return OtherworldInnHudClient.getEnableMod() && (CurrentMinimap.noMinimapLoaded()
        || !OtherworldInnHudClient.getEnableMinimapIntegration() || minimapIntegrationHidden(mc));
  }

  public static boolean drawDefaultHudMenu() {
    return (OtherworldInnHudClient.getEnableMod() && (CurrentMinimap.noMinimapLoaded()
        || !OtherworldInnHudClient.getEnableMinimapIntegration() || OtherworldInnHudClient.getShowDefaultWhenMinimapHidden()));
  }
